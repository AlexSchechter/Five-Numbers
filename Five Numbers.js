function calculations() {
	...
	/*if (firstNumber.length === 0 || secondNumber.length === 0 || thirdNumber.length === 0 || fourthNumber.length === 0 || fifthNumber.length === 0 ) {
		alert('Please enter a number in each of the boxes!');
		return;
	}*/
